"""
Text-to-Background ツール
Gemini 2.5 Flash Image による背景画像生成（16:9固定）
"""
...
@tool
def text_to_background(prompt: str) -> dict:
    """
    背景画像を生成します（16:9固定、テキストなし）。

    Args:
        prompt: 背景画像のプロンプト。背景のスタイルや雰囲気を指示します。
